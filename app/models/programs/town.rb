class Programs::Town
  ...
  def generate_explanation
    self.explanation = {}
    self.explanation['kfkv'] = self.load_from_csv 'db/functions_kfkv_codes.uk.csv'    # functional code (branch of a program)
    self.explanation['kvkv'] = self.load_from_csv 'db/departments_kvkv_codes.uk.csv'  # chief steward (department)
