module Properting
  class PropertiesController < ApplicationController
    ...
    before_action :set_properting_property, only: [:show,
                                                   :edit,
                                                   :update,
                                                   :destroy,
                                                   :show_property_info,
    ...
    def show_property_info
      ...
      if @properting_property.obj_owner.blank?
        ...
        unless prozzoro_info.nil?
          @properting_property.obj_owner = prozzoro_info['awards'].first['suppliers'].first['name'] unless prozzoro_info['awards'].blank?
        end
      end
